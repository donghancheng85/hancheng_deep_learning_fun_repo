...
# get the transforms from efficientnet_b0 weights
...
# Set up efficientnet_b0 model with pretrained weights
...
confusion_matrix_save_path = "lessons/section8_pytorch_transfer_learning/src/d_line_104_confusion_matrix_double_training_data.png"
